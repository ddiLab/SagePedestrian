...
def write_label_xmls(model, image_path):
    ...
    if var_date_object.day > 0 and var_date_object.month >= 0 and 13 <= var_time_object.hour <= 22 and var_time_object.minute > 58: # change this 13 to run more than 1 hour
